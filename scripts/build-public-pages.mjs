...
export function buildPages(out, download = process.env.LECTERN_DOWNLOAD_URL, distribution = process.env.LECTERN_COMPANION_DISTRIBUTION ?? 'unsigned') {
