...
const zh: Dict = {
  ...
  'git.modeDirect': '直接比较',
  'git.refresh': '重新比较',
  'git.refreshTitle': '使用当前端点重新读取本地状态',
  'git.resizeChanges': '调整变更文件列表宽度',
...
const en: Dict = {
  ...
  'git.refresh': 'Recompare',
  'git.refreshTitle': 'Re-read local state with the current endpoints',
  'git.resizeChanges': 'Resize the changed-files list',
